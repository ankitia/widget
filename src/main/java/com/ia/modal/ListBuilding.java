...
public class ListBuilding {
	...
	public String getCompany_tenure() {
		return company_tenure;
	}
	public void setCompany_tenure(String company_tenure) {
		this.company_tenure = company_tenure;
	}
