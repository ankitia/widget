  ...
  <body>
    ...
    <div id="wrap">
      ...
      <div class="container" style="margin-top: 10px;">
        ...
        <font style="text-align: left;" size="3" ><strong> Pending </strong> ${listVerificationActive }</font> <br />
        ...
        <font style="text-align: left;" size="3" ><strong> Approved </strong> (<a href="<%=request.getContextPath() %>/listBuildVerificationLog">${listVerificationApproved }</a>) </font> <br />
