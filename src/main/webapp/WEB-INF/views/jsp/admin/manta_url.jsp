  ...
  <body>
    ...
    <div id="wrap">
      ...
      <div class="container" style="margin-top: 10px;">
        ...
        <font style="text-align: left;" size="3" ><strong> Approved </strong> (<a href="<%=request.getContextPath() %>/mantaVerificationLog">${userVerificationApproved }</a>) </font> <br />
        <font style="text-align: left;" size="3" ><strong> Missed </strong> (<a href="<%=request.getContextPath() %>/mantaVerificationMissed">${userVerificationAll -(userVerificationActive +userVerificationApproved)}</a>)</font> <br />
  
		<c:if test="${userVerificationActive == 0}">
        	<input type="button" name="getMoreLinks" id="getMoreLinks" class="btn btn-primary" onclick="getMoreLinks('assignMantaData')" value="Get More 10 Links">
        </c:if>
        <br /> <br /> 
