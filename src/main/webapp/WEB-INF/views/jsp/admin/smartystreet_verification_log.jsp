...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Smartystreet Verification Log</title> 
      ...
      <div class="container text-center" style="margin-top: 50px;">
         ...
         <table class="table table-striped" style="    font-size: 13px;">
             ...
             <c:forEach items="${getScrap }" var="getScrap" varStatus="index">         
	         	<tr>
	         		<td>${index.count } </td> 
	         		<td>${getScrap.entered_address } </td>
	         		<td>${getScrap.found_addresses } </td>
	         		<td>${getScrap.root_url } </td>	         		
	         		<td><a href="#" title="${getScrap.root_url }"> Link ${getScrap.url_id }</a> </td>
	         	</tr>	
	         </c:forEach>
         </table>
