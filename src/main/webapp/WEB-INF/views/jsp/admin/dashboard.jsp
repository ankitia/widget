      ...
      <div class="container text-center" style="margin-top: 50px;">
         ...
         <table class="table table-striped" style="    font-size: 16px;">
		    ...
		    <% if(session.getAttribute("approvedLink")==null || session.getAttribute("approvedLink").toString().trim()=="" || session.getAttribute("approvedLink").toString().length() == 0){  %>
				   <h3 id="totalApproved" class="text-left">User Verification till(26-Jul-2019) :  ${userVerificationApprovedLog } <a href="#" onclick="return setTotal(${userVerificationApprovedLog},'scrap1')" class="btn btn-primary">Please confirm </a> </h3>
			<% }else{
				%>
				<h3  class="text-left">User Verification till(26-Jul-2019) :  ${userVerificationApprovedLog } <a href="#" class="btn btn-primary">Approved </a> </h3>
			...
			<% }%>--%>
				   ...
				   <h3 id="totalApproved2" class="text-left">Company Details from (01-Jul-2019) to (26-Jul-2019) :  ${companyVerification } <a href="#" onclick="return setTotal(${companyVerification},'company_log')" class="btn btn-primary">Please confirm </a> </h3>
			<% }else{
				%>
				<h3  class="text-left">Company Details from (01-Jul-2019) to (26-Jul-2019) :  ${companyVerification } <a href="#" class="btn btn-primary">Approved </a> </h3>
