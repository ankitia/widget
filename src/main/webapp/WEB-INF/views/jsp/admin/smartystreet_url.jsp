    ...
    <div id="wrap">
      ...
      <div class="container" style="margin-top: 10px;">
		...
		<c:if test="${userVerificationActive == 0}">
        	<input type="button" name="getMoreLinks" id="getMoreLinks" class="btn btn-primary" onclick="getMoreLinks('assignSmartyStreetData')" value="Get More 10 Links">
        </c:if>
        <br /> <br /> 
