...
(function ($) {
	...
	$(".hero-slider").owlCarousel({
		...
		rewindNav: true,
		loop: true,
		navText: ["<img src='resources/img/assets/slider-left-thin-arrow.png'>", "<img src='resources/img/assets/slider-right-thin-arrow.png'>"]
	});
	...
	$(".project-carousel,.slider-block-1").owlCarousel({
		...
		dots: true,
		nav: true,
		navText: ["<img src='resources/img/assets/slider-left-thin-arrow-dark.png'>", "<img src='resources/img/assets/slider-right-thin-arrow-dark.png'>"]
	});
	...
	$('#contactform').submit(function () {
		...
		$("#message").slideUp(250, function () {
			$('#message').hide();
			$('#submit')
				.after('<img src="resources/img/assets/contact-form-loader.gif" class="loader" />')
	...
	$(function () {
		if ($('#twitter-feed').length) {
			...
			twitterUser = $("#twitter-feed").data("twitter-widget-id");
			tweets = {
				"id": twitterUser,
				"domId": 'twitter-feed',
				"maxTweets": 2,
